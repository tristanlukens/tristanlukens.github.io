import{S as x,i as C,s as E,B as N,e as b,j as v,v as I,V as O,c as f,d as l,l as _,a as k,w as S,b as m,D as g,f as T,x as $,y as P,z as W,p as A,n as M,A as j}from"../chunks/vendor-f28c4b56.js";import{T as D}from"../chunks/title-53d80759.js";import{A as z}from"../chunks/article-94fdd433.js";function H(c){let t,d,a,n,p,i,o,h;n=new D({props:{first:"about",second:"me"}});const u=[{aboutme:!0},c[0]];let w={};for(let e=0;e<u.length;e+=1)w=N(w,u[e]);return o=new z({props:w}),{c(){t=b("meta"),d=v(),a=b("main"),I(n.$$.fragment),p=v(),i=b("div"),I(o.$$.fragment),this.h()},l(e){const s=O('[data-svelte="svelte-11mdtje"]',document.head);t=f(s,"META",{name:!0,content:!0}),s.forEach(l),d=_(e),a=f(e,"MAIN",{class:!0});var r=k(a);S(n.$$.fragment,r),p=_(r),i=f(r,"DIV",{class:!0});var y=k(i);S(o.$$.fragment,y),y.forEach(l),r.forEach(l),this.h()},h(){document.title="tristanlukens | About",m(t,"name","description"),m(t,"content","About page of Tristan Lukens' personal website."),m(i,"class","-mt-8"),m(a,"class","page")},m(e,s){g(document.head,t),T(e,d,s),T(e,a,s),$(n,a,null),g(a,p),g(a,i),$(o,i,null),h=!0},p(e,[s]){const r=s&1?P(u,[u[0],W(e[0])]):{};o.$set(r)},i(e){h||(A(n.$$.fragment,e),A(o.$$.fragment,e),h=!0)},o(e){M(n.$$.fragment,e),M(o.$$.fragment,e),h=!1},d(e){l(t),e&&l(d),e&&l(a),j(n),j(o)}}}function L(c){return[{title:void 0,source:`
...
I could talk about lots and lots more, but the rest will come with blog posts :)
		`,author:"Tristan Lukens",date:"04-01-2022"}]}class V extends x{constructor(t){super();C(this,t,L,H,E,{})}}export{V as default};
